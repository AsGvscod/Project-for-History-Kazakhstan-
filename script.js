...
const QUIZ_BANKS = {
  ...
  2: [
    { questionText: "The famous \"Golden Man\" (Golden Warrior) was discovered near which site?", variants: ["Issyk kurgan", "Berel kurgan", "Pazyryk", "Botai"], rightAnswerIndex: 0 },
    { questionText: "The Saka tribes are primarily classified as:", variants: ["settled farmers", "nomadic pastoralists", "seafaring traders", "urban artisans"], rightAnswerIndex: 1 },
    { questionText: "The Wusun state was located mainly in the region of:", variants: ["Semirechye (Zhetysu)", "Ustyurt Plateau", "Mangystau", "Altai"], rightAnswerIndex: 0 },
    { questionText: "The Kangju state controlled territories mainly along the:", variants: ["Ili river", "Syrdarya river", "Irtysh river", "Ural river"], rightAnswerIndex: 1 },
    { questionText: "The Xiongnu (Hunnu) confederation was primarily centered in:", variants: ["Mongolian steppe", "Iranian plateau", "Indus valley", "Caucasus"], rightAnswerIndex: 0 },
    { questionText: "The Great Silk Road mainly connected:", variants: ["Europe and Africa", "China and the Mediterranean world", "India and Japan", "Egypt and Rome only"], rightAnswerIndex: 1 },
    { questionText: "The First Turkic Khaganate was founded in the:", variants: ["3rd century BC", "1st century AD", "6th century AD", "10th century AD"], rightAnswerIndex: 2 },
    { questionText: "The title of the supreme ruler of the Turkic Khaganate was:", variants: ["Khan", "Khagan", "Sultan", "Beg"], rightAnswerIndex: 1 },
    { questionText: "Saka burial mounds are commonly known as:", variants: ["dolmens", "kurgans", "megaliths", "cairns"], rightAnswerIndex: 1 },
    { questionText: "Which decorative style is closely associated with Saka gold artifacts?", variants: ["\"Animal style\"", "Geometric mosaics", "Cast iron reliefs", "Glass beadwork"], rightAnswerIndex: 0 },
  ],
  3: [
    { questionText: "The Turgesh Khaganate emerged after the decline of the:", variants: ["Western Turkic Khaganate", "Xiongnu confederation", "Kangju state", "Golden Horde"], rightAnswerIndex: 0 },
    { questionText: "The Qarluk state was primarily located in the region of:", variants: ["Semirechye", "Mangystau", "Aral Sea area", "Altai"], rightAnswerIndex: 0 },
    { questionText: "\"Desht-i-Qypchaq\" refers to the:", variants: ["Kypchak steppe", "a Silk Road city", "Mongol capital", "Kazakh Khanate's court"], rightAnswerIndex: 0 },
    { questionText: "The Mongol conquest of Central Asia was led primarily by:", variants: ["Timur", "Genghis Khan", "Attila", "Babur"], rightAnswerIndex: 1 },
    { questionText: "The Golden Horde is also known as the:", variants: ["Ulus of Ogedei", "Ulus of Jochi", "Ulus of Chagatai", "Ulus of Tolui"], rightAnswerIndex: 1 },
    { questionText: "The Kazakh Khanate was founded around:", variants: ["1219–1221", "1465–1466", "1783–1797", "1731–1740"], rightAnswerIndex: 1 },
    { questionText: "The founders of the Kazakh Khanate were:", variants: ["Kerey and Janibek", "Abylai and Ablai", "Tauke and Kasym", "Esim and Zhangir"], rightAnswerIndex: 0 },
    { questionText: "The Kazakh Khanate was first established in the region of:", variants: ["Zhetysu (Semirechye)", "Mangystau", "Turkestan only", "Altai"], rightAnswerIndex: 0 },
    { questionText: "The Oghuz state was centered mainly around the lower:", variants: ["Syrdarya river", "Ili river", "Ural river", "Irtysh river"], rightAnswerIndex: 0 },
    { questionText: "Under Mongol rule, conquered territories were divided into administrative units called:", variants: ["Uluses", "Khanates only", "Emirates", "Sultanates only"], rightAnswerIndex: 0 },
  ],
};
